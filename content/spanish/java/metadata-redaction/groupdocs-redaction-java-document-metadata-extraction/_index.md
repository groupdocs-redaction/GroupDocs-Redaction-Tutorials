---
date: '2026-03-22'
description: Aprende cómo leer metadatos de archivos en Java, obtener el tipo de archivo
  y obtener el recuento de páginas usando GroupDocs.Redaction para Java. Guía paso
  a paso con ejemplos de código.
keywords:
- GroupDocs.Redaction Java
- document metadata extraction
- Java stream APIs
title: java leer metadatos del archivo – tipo de archivo con GroupDocs.Redaction
type: docs
